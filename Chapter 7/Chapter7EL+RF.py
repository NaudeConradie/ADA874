...
PROJECT_ROOT_DIR = r"C:\Naudé\University\Advanced Data Analytics\ADA874\Chapter 7"
CHAPTER_ID = "Chapter7ELRF"
...
def save_fig(fig_id, tight_layout=True):
    ...
    if tight_layout:
        plt.tight_layout()
    plt.savefig(path, format='png', dpi=300, facecolor='w', edgecolor='b')
